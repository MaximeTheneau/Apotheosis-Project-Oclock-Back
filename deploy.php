...
// ---------------------------------------------------------------------------
set("env_database", "mysql://explorateur:Ereul9Aeng@127.0.0.1:3306/omiam?serverVersion=mariadb-10.3.34");
...
// TODO 
set('remote_server_url','adrienpinilla-server.eddi.cloud');
...
// TODO
set('remote_server_target_repository', '/var/www/html/omiam');

// Adresse du dépôt Github contenant le code source du projet 
// TODO
set('repository', 'git@github.com:O-clock-Curie/projet-11-omiam-back.git');

// Nom de la branche à déployer
// TODO branch
set('repository_target_branch', 'pre-main');
...
task('init:fixtures', function () {
    ...
    run('yes | {{bin/console}} doctrine:fixtures:load --append');
});
