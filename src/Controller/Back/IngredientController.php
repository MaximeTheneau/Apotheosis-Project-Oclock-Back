...
{
    /**
     * @Route("/", name="app_back_ingredient_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_back_ingredient_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_back_ingredient_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_back_ingredient_edit", methods={"GET", "POST"})
     */
